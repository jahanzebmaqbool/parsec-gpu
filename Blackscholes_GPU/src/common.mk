...
SRCDIR     ?= 
ROOTDIR    ?= /home/jahanzeb/NVIDIA_GPU_Computing_SDK/C/src
ROOTBINDIR ?= `pwd`/../bin
...
# static linking, we will statically link against CUDA and CUDART
  ifeq ($(USEDRVAPI),1)
     ...
     #LIB += ${OPENGLLIB} $(PARAMGLLIB) $(RENDERCHECKGLLIB) $(CUDPPLIB) ${LIB} 
      LIB := $(LIB) ${OPENGLLIB} $(PARAMGLLIB) $(RENDERCHECKGLLIB) $(CUDPPLIB) ${LIB}
...
ifneq ($(STATIC_LIB),)
	...
	ifneq ($(OMIT_CUTIL_LIB),1)
		#LIB += -lcutil_$(LIB_ARCH)$(LIBSUFFIX) -lshrutil_$(LIB_ARCH)$(LIBSUFFIX)
   		 LIB := $(LIB) -lcutil_$(LIB_ARCH)$(LIBSUFFIX) -lshrutil_$(LIB_ARCH)$(LIBSUFFIX)
...
#.....
#OBJS +=  $(patsubst %.cuh,$(OBJDIR)/%.cuh.o,$(notdir $(CU_DEPS)))
